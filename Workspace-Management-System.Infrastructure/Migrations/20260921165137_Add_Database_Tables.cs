...
{
    /// <inheritdoc />
    public partial class Add_Database_Tables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxInformation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Companies_PricingPlans_PricingPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkspaceTypeId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MembershipBenefits_WorkspaceTypes_WorkspaceTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PricingRules_PricingPlans_PricingPlanId",
                        column: x => x.PricingPlanId,
                        principalTable: "PricingPlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PricingRules_WorkspaceTypes_WorkspaceTypeId",
                        column: x => x.WorkspaceTypeId,
                        principalTable: "WorkspaceTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerMemberships", x => new { x.CustomerId, x.MembershipId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RemainingHours = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "SessionWorkspaceHistories",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionWorkspaceHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SessionWorkspaceHistories_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SessionWorkspaceHistories_Sessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "Sessions",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SessionWorkspaceHistories_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransactionItems_Discounts_DiscountId",
                        column: x => x.DiscountId,
                        principalTable: "Discounts",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Companies_PricingPlanId",
                table: "Companies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MembershipBenefits_WorkspaceTypeId",
                table: "MembershipBenefits",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PricingRules_PricingPlanId",
                table: "PricingRules",
                column: "PricingPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_PricingRules_WorkspaceTypeId",
                table: "PricingRules",
                column: "WorkspaceTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionWorkspaceHistories_EmployeeId",
                table: "SessionWorkspaceHistories",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_SessionWorkspaceHistories_SessionId",
                table: "SessionWorkspaceHistories",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_SessionWorkspaceHistories_WorkspaceId",
                table: "SessionWorkspaceHistories",
                column: "WorkspaceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionItems_DiscountId",
